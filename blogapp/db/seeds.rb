...
reblog1 = Reblog.create({user_id: 1, original_post_id: post2.id})
reblog2 = Reblog.create({user_id: 2, original_post_id: post3.id})
reblog3 = Reblog.create({user_id: 6, original_post_id: post4.id})
